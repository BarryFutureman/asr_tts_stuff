my_original_dataset_name = "BarryFutureman/kara2_handpicked"
name_to_push_dataset_to = "BarryFutureman/kara-filtered-tokenized-snac"
SPEAKER_NAME = "KARA"
...
def create_input_ids(example):
    text_prompt = f"{SPEAKER_NAME}: {example['text']}"
